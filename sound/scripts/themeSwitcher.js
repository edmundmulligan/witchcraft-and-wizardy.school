  ...
  class ThemeSwitcher {
    ...
    applyTheme(theme, style = null) {
      ...
      root.style.setProperty(
        '--colour-effective-page-background',
        `var(${prefix}-page-background)`
      );
      root.style.setProperty('--colour-effective-page-text', `var(${prefix}-page-text)`);
      root.style.setProperty(
        '--colour-effective-headings-background',
        `var(${prefix}-headings-background)`
      );
      root.style.setProperty('--colour-effective-headings-text', `var(${prefix}-headings-text)`);
      root.style.setProperty(
        '--colour-effective-code-background',
        `var(${prefix}-code-background)`
      );
      root.style.setProperty('--colour-effective-code-text', `var(${prefix}-code-text)`);
      root.style.setProperty(
        '--colour-effective-button-background',
        `var(${prefix}-button-background)`
      );
      root.style.setProperty('--colour-effective-button-text', `var(${prefix}-button-text)`);
      root.style.setProperty(
        '--colour-effective-button-background-hover',
        `var(${prefix}-button-background-hover)`
      );
      root.style.setProperty(
        '--colour-effective-button-text-hover',
        `var(${prefix}-button-text-hover)`
      );
      root.style.setProperty(
        '--colour-effective-button-background-selected',
        `var(${prefix}-button-background-selected)`
      );
      root.style.setProperty(
        '--colour-effective-button-text-selected',
        `var(${prefix}-button-text-selected)`
      );
      root.style.setProperty(
        '--colour-effective-button-background-disabled',
        `var(${prefix}-button-background-disabled)`
      );
      root.style.setProperty(
        '--colour-effective-button-text-disabled',
        `var(${prefix}-button-text-disabled)`
      );
      root.style.setProperty(
        '--colour-effective-menu-background',
        `var(${prefix}-menu-background)`
      );
      root.style.setProperty('--colour-effective-menu-text', `var(${prefix}-menu-text)`);
      root.style.setProperty(
        '--colour-effective-menu-background-hover',
        `var(${prefix}-menu-background-hover)`
      );
      root.style.setProperty(
        '--colour-effective-menu-text-hover',
        `var(${prefix}-menu-text-hover)`
      );
      root.style.setProperty(
        '--colour-effective-menu-background-visited',
        `var(${prefix}-menu-background-visited)`
      );
      root.style.setProperty(
        '--colour-effective-menu-text-visited',
        `var(${prefix}-menu-text-visited)`
      );
      root.style.setProperty(
        '--colour-effective-menu-background-focus',
        `var(${prefix}-menu-background-focus)`
      );
      root.style.setProperty(
        '--colour-effective-menu-text-focus',
        `var(${prefix}-menu-text-focus)`
      );
      root.style.setProperty(
        '--colour-effective-link-background',
        `var(${prefix}-link-background)`
      );
      root.style.setProperty('--colour-effective-link-text', `var(${prefix}-link-text)`);
      root.style.setProperty(
        '--colour-effective-link-background-hover',
        `var(${prefix}-link-background-hover)`
      );
      root.style.setProperty(
        '--colour-effective-link-text-hover',
        `var(${prefix}-link-text-hover)`
      );
      root.style.setProperty(
        '--colour-effective-link-background-visited',
        `var(${prefix}-link-background-visited)`
      );
      root.style.setProperty(
        '--colour-effective-link-text-visited',
        `var(${prefix}-link-text-visited)`
      );
      root.style.setProperty(
        '--colour-effective-link-background-focus',
        `var(${prefix}-link-background-focus)`
      );
      root.style.setProperty(
        '--colour-effective-link-text-focus',
        `var(${prefix}-link-text-focus)`
      );
    ...
    updateStyleButtons(style) {
      ...
      if (normalButton && subduedButton && vibrantButton) {
        ...
        Debug.log(
          ...
          '| Subdued:',
          subduedButton.className,
          '| Vibrant:',
          vibrantButton.className
        );
      } else {
