...
<div class="header-minimal">
    <div class="header-text">
        <img class="header-image mirror inline-header" src="${pathPrefix}images/cat-1299082.svg" alt="" aria-hidden="true">
        ...
        <img class="header-image inline-header" src="${pathPrefix}images/witch-151167.svg" alt="" aria-hidden="true">
