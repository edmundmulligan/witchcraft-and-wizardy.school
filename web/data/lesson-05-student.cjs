    ...
    },
    {
      ...
      content: `
            ...
            <div id="types-of-hyperlinks-block">
              ...
              <p>
                The <code>url</code> attribute in the <code>&lt;a&gt;</code> element can point to different types of
                resources, such as:
              </p>
              <ul>
            ...
            <div id="what-does-it-mean-block">
              ...
              <ul>
                ...
                <li>
                  ...
                  like images you have used in previous lessons, but by giving it a <code>url</code> attribute, you
