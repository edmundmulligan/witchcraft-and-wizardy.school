...
% colours for web sites and artwork
\definecolor{web_background_dark}{HTML}{4B0082}               % Indigo
\definecolor{web_background_dark_highlight}{HTML}{E0FFFF}     % light cyan
\definecolor{web_background_dark_alt}{HTML}{ADD8E6}           % light blue
\definecolor{web_background_light}{HTML}{E0FFFF}              % light cyan
\definecolor{web_background_light_highlight}{HTML}{4B0082}    % indigo
\definecolor{web_background_light_alt}{HTML}{9370DB}          % medium purple
