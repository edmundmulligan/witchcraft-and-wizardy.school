...
\begin{document}
  \begin{tikzpicture}
    ...
    % Friendly labels
    \node[tem_purple, font=\small\sffamily, opacity=0.6] at (2.7, 3.0) {Design};
    \node[tem_cyan, font=\small\sffamily, opacity=0.6] at (4.2, 5.5) {Responsive};
    \node[tem_purple, font=\small\sffamily, opacity=0.6] at (4.0, 1.5) {Creative};
