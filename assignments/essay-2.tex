...
only one JavaScript function). A fourth principle, which is not referenced as I worked it out 
...
complex CSS later. The current codebase is not optimal in this regard and with more time 
...
801px to 1600px & Desktop layout & Prefer horizontal layout \\
1601px and above & Large desktop layout & Need to avoid fonts looking too small in large viewports \\
\bottomrule
\end{tabular}
...
student page. Due to my experimental approach to development, early versions of 
the website had several levels of nested grids and flexboxes which then had to 
be refactored to simpler layouts as I learned more about the strengths and 
weaknesses of each choice.
...
the choices passed the contrast tests in the accessibility tools.
