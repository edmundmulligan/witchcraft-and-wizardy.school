...
could be improved. The student.html page is a particular example where the CSS is more complex
...
\toprule
1 & Reactive code does not work well at extreme viewport sizes & 
...
3 & The artwork provided by Rachel Mulligan is in JPEG format with a white background. & 
    The picture gallery looks unprofessional with white boxes around images. & 
    Images need to be edited to have transparent backgrounds (PNG or SVG format). \\
\midrule
4 & student.css is a mess. &
    Doesn't conform to standards in other css files. &
