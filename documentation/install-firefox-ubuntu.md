...
**Good news!** Firefox usually comes pre-installed on Ubuntu, so you might already have it!
...
4. Firefox will now appear in your application dock/launcher!
...
- ✅ Works on Ubuntu, Windows, macOS, and phones
- ✅ Thousands of free add-ons available
- ✅ Great integration with Ubuntu
- ✅ Uses less RAM than Chrome
- ✅ Often pre-installed on Ubuntu

## Alternative: Firefox via Snap

Ubuntu may install Firefox as a Snap package (a containerized app). This is fine and works the same way. If you prefer the traditional .deb version, you can search online for "Firefox .deb Ubuntu" for instructions.
