# How to Create a Projects Folder on Ubuntu
...
This is the easiest way to create your Projects folder using Ubuntu's file manager.

### Step 1: Open Files

1. Click the **Files** icon in your Dock/launcher (folder icon)
   - Or press **Super + E** (Super is the Windows/Ubuntu key)
   - Or click **Activities** and search for "Files"
...
1. Press **Ctrl + Alt + T** (the quickest way!)
   - Or click **Activities**, type "Terminal", and press **Enter**
   - Or right-click on the desktop and choose **Open Terminal** (if available)
...
2. To check it was created, type:
   ...
   ls
   ```
   - You should see "Projects" in the list (it will be blue, indicating it's a folder)
...
```
(Replace "yourname" with your actual Ubuntu username)
...
4. Now it will always be in your left sidebar!
...
- 💾 Use backup tools like Timeshift or Deja Dup to backup your Projects folder

## Keyboard Shortcuts for Ubuntu

- **Ctrl + Alt + T** - Open Terminal
- **Super + E** - Open Files (on some systems)
- **Ctrl + D** - Add bookmark in Files
